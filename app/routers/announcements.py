...
router = APIRouter(prefix="/announcements", tags=["announcements"], dependencies=[Depends(require_roles("manager", "board_member"))])
...
@router.post("", response_model=Announcement, dependencies=[Depends(require_roles("manager"))])
...
@router.patch("/{announcement_id}", response_model=Announcement, dependencies=[Depends(require_roles("manager"))])
...
@router.post("/{announcement_id}/publish", response_model=Announcement, dependencies=[Depends(require_roles("manager"))])
...
@router.post("/generate-ai", response_model=AnnouncementGenerationResponse, dependencies=[Depends(require_roles("manager"))])
