...
async def post_attachment(
    ...
    return await create_attachment(db, file, condominium_id, entity_type, entity_id, uploaded_by_user_id, visibility)
...
@router.post("/tickets/{ticket_id}/attachments", response_model=Attachment)
async def post_ticket_attachment(
    ...
    return await create_attachment(db, file, condominium_id, "ticket", ticket_id, uploaded_by_user_id, visibility)
...
@router.post("/payments/{payment_id}/attachments", response_model=Attachment)
async def post_payment_attachment(
    ...
    return await create_attachment(db, file, condominium_id, "payment", payment_id, uploaded_by_user_id, visibility)
...
@router.post("/kanban/items/{item_id}/attachments", response_model=Attachment)
async def post_kanban_attachment(
    ...
    return await create_attachment(db, file, condominium_id, "work_item", item_id, uploaded_by_user_id, visibility)
